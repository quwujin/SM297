<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RedPrizeconfig.aspx.cs" Inherits="MyAdmin_Config_RedPrizeconfig" %>
...
<body style="background:#fff;">
  ...
  <div class="table-header">
        <strong runat="server" id="jx_tle">微信红包中奖配置管理</strong> 
  </div>  
		 <br />
              ...
              <tr>
                <td width="393"  height="40" class="auto-style1"><div align="center" id="one_div" runat="server">一等奖中奖率(888元)</div></td>
              ...
              <tr>
                <td height="40" class="auto-style1"><div align="center" id="two_div" runat="server">二等奖中奖率(80元)</div></td>
                <td width="615" height="35">&nbsp;
             ...
             <tr id="three_tr" runat="server" visible="true">
                <td height="40" class="auto-style1"><div align="center" id="three_div" runat="server">三等奖中奖率(60元)</div></td>
                <td width="615" height="35">&nbsp;
              ...
              <tr id="four_tr" runat="server" visible="true">
                <td height="40" class="auto-style1"><div align="center" id="four_div" runat="server">四等奖中奖率(20元)</div></td>
                <td width="615" height="35">&nbsp;
              ...
              <tr id="five_tr" runat="server" visible="true">
                <td height="40" class="auto-style1"><div align="center" id="five_div" runat="server">五等奖中奖率(10元)</div></td>
                <td width="615" height="35">&nbsp;
              ...
              <tr id="six_tr" runat="server" visible="true">
                <td height="40" class="auto-style1"><div align="center" id="six_div" runat="server">六等奖中奖率(2元)</div></td>
                <td width="615" height="35">&nbsp;
               ...
               <tr>
                <td height="40" class="auto-style1"><div align="center" id="seven_div" runat="server">参与奖中奖率(1元)</div></td>
                <td width="615" height="35">&nbsp;
