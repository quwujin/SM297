<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminOperationLog.aspx.cs" Inherits="AdminOperationLog" %>
                    ...
                    <div>
                        ...
                        <table id="checkSelect" width="100%" class="table table-bordered"   >
                              <tr> 
                                  ...
                                  <td>
                                       <asp:TextBox ID="tbCheckName" runat="server" ></asp:TextBox>
                                  </td>
                                  <td>
                                 ...
                                 <td style="text-align:right">
                                     ...
                                     <asp:Button ID="Button4" runat="server" Text="导 出" Visible="false"  CssClass="btn btn-success" OnClick="Button2_Click" />
                                   </td> 
                                ...
                                <asp:Repeater runat="server" ID="menuList">
                                    <ItemTemplate>
                                        <tr >
                                            ...
                                            <td ><%#Eval("LStatus").ToString()=="0"?"未审核":Eval("Status").ToString()=="1"?"已审核":"已作废" %></td> 
                                            <td ><%#Eval("Status").ToString()=="0"?"未审核":Eval("Status").ToString()=="1"?"已审核":"已作废" %></td> 
                                            <td ><%#Eval("CreateTime") %></td>
                                            <td ><%#Eval("UpdateTime") %></td>
                                            <td ><%#Eval("UserName")%> </td>
                                            <td ><%#Eval("Remark")%> </td> 
                                            <td><div style="display:<%=userseesion.GroupId==2?"block":"none"%>"><%#Eval("HideContent") %></div></td>
                                            <%--<td>
                                            </td>--%>
