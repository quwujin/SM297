<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrivacyConfig.aspx.cs" Inherits="MyAdmin_System_SearchStock" %>
...
<body style="background:#fff;">
    <form id="form1" runat="server">
     ...
     <el-dialog title="配置管理" :visible.sync="dialogFormVisible" width="30%" :before-close="handleCancel"  center>
        ...
        <el-form-item label="配置组" :label-width="formLabelWidth">
            ...
            <el-option label="隐私设置" value="29"></el-option>
     ...
     <div class="table-header"> 隐私设置 </div> 
     <table  border="0" align="center"  class="table table-bordered"  >
         <tr v-for="item in ConfigArray">
            ...
            <td style="font-size:16px;" >
               {{item.Val}}
                <template v-if="item.KId==51||item.KId==50">
                    %
                </template>
            </td>
            <td> 
    ...
    <script>
        ...
        var vue = new Vue({
            ...
            data: {
                RequestUrl: {
                    Url: "/MyAdmin/Handler/PrivacyConfig.ashx"
                },
                ConfigArray: [],
